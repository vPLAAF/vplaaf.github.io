...
export default function HomePage() {
    return (
        <div className="relative min-h-screen bg-black text-slate-100 overflow-hidden">
            ...
            {/* 背景图右版权 */}
            <div className="fixed right-3 bottom-3 z-10 rounded-md bg-slate-900/40 px-2 py-1 text-[10px] text-slate-300 backdrop-blur-sm border border-slate-700/50">
                <a href="https://commons.wikimedia.org/wiki/File:Two_J-20s_at_CCAS2022_(20220827103238).jpg">背景图: N509FZ</a>, <a href="https://creativecommons.org/licenses/by-sa/4.0">CC BY-SA 4.0</a>, 通过维基共享资源
            </div>
      ...
      "
                    ...
                    <section className="mt-10">
                        <div className="rounded-xl border border-red-500/40 bg-red-950/40 px-4 py-3 text-xs text-red-100 sm:text-sm">
                            <p className="font-semibold">重要免责声明 / Important Disclaimer</p>
                            <p className="mt-2 text-[11px] leading-relaxed sm:text-xs">
                                vPLAAF（虚拟中国空军）为完全虚构的虚拟飞行组织，
